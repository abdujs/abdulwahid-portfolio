...
export function EnhancedHero() {
  return (
    <section
      id="hero"
      className="relative isolate flex min-h-screen items-center pb-24 pt-20 sm:pt-24"
    >
      <motion.div
        variants={container}
        initial="hidden"
        ...
        <div className="flex flex-col gap-10 lg:flex-row lg:items-center lg:gap-12">
          <motion.div variants={item} className="flex flex-col gap-6 lg:w-3/5">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <Link
                ...
                className="inline-flex items-center justify-center rounded-full border border-blue-400/20 bg-blue-500/10 p-3 text-blue-400 transition hover:-translate-y-0.5 hover:border-pink-400 hover:text-pink-400 focus-visible:outline focus-visible:outline-offset-2 focus-visible:outline-pink-400"
                aria-label="View CV"
              >
          ...
          <motion.div variants={item} className="lg:w-2/5">
            ...
            <div className="mt-4 flex flex-col items-center gap-3 text-slate-200">
              <div className="inline-flex items-center gap-2 rounded-full bg-slate-900/70 px-3 py-2 text-sm">
